      ...
      <section className="pt-32 pb-20 bg-gradient-to-br from-gray-50 via-white to-primary/5">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Test avec nouveau token GitHub
            </motion.p>
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-light mb-4">Mon Entreprise Test</h2>
            <p className="text-gray-400 mb-8">Technologie</p>
            <div className="pt-8 border-t border-gray-800">
              <p className="text-gray-500">&copy; 2025 Mon Entreprise Test. Tous droits réservés.</p>
            </div>
          </div>
        </div>
      </footer>
